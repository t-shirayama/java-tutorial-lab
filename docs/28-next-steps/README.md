...
- Webアプリ、実務開発、並行処理のどこへ進むか選ぶ観点
- Spring Boot、JUnit、Git、CIなど次に触れる道具
- 公式資料を全部読むのではなく、今使うAPIから調べる読み方
- 小さな成果物を作り、動かし、テストしながら広げる学習方法
...
Spring Boot、データベース、テスト、CI、並行処理を同時に始めると、どこでつまずいているか分かりにくくなります。まずは1つの小さな成果物を選び、動く状態を保ちながら機能を足してください。
