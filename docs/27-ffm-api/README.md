...
通常のJava基礎、Webアプリケーション、業務アプリケーションを学ぶ段階では、先に1〜26章を固めてから戻ってくるくらいで十分です。
...
docker compose exec -w /workspace/docs/27-ffm-api/examples java mvn compile exec:java
```
